...
namespace LinearStateEstimator
{
    ...
    public partial class ServiceInstall : InstallerBase
    {
        ...
        protected override string ConfigurationName
        {
            get
            {
                return "LinearStateEstimator.exe.Config";
            }
        }
        ...
        protected override void OnSystemSettingsLoaded(XmlDocument configurationFile, XmlNode systemSettingsNode)
        {
            ...
            else
            {
                ...
                companyNameNode.Attributes.Append(CreateAttribute(configurationFile, "description", "The name of the company who owns this instance of the LinearStateEstimator."));
            ...
            else
            {
                ...
                companyAcronymNode.Attributes.Append(CreateAttribute(configurationFile, "description", "The acronym representing the company who owns this instance of the LinearStateEstimator."));
