...
SET db[1]="LinearStateEstimator.db"
SET db[2]="LinearStateEstimator-InitialDataSet.db"
SET db[3]="LinearStateEstimator-SampleDataSet.db"
SET script[1]="LinearStateEstimator.sql"
