--  ----------------------------------------------------------------------------------------------------
--  LinearStateEstimator Data Structures for MySQL - Gbtc
--
...
CREATE DATABASE LinearStateEstimator CHARACTER SET = UTF8;
...
-- GRANT SELECT, UPDATE, INSERT, DELETE ON LinearStateEstimator.* TO NewUser;
