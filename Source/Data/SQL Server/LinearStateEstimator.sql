--  ----------------------------------------------------------------------------------------------------
--  LinearStateEstimator Data Structures for SQL Server - Gbtc
--
...
--       Script is based on LinearStateEstimator.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [LinearStateEstimator];
GO
ALTER DATABASE [LinearStateEstimator] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET ARITHABORT OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [LinearStateEstimator] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [LinearStateEstimator] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [LinearStateEstimator] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET  ENABLE_BROKER 
GO
ALTER DATABASE [LinearStateEstimator] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [LinearStateEstimator] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [LinearStateEstimator] SET  READ_WRITE 
GO
ALTER DATABASE [LinearStateEstimator] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [LinearStateEstimator] SET  MULTI_USER 
GO
ALTER DATABASE [LinearStateEstimator] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [LinearStateEstimator] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the LinearStateEstimator database.
...
--GO
USE [LinearStateEstimator]
GO
--CREATE USER [NewUser] FOR LOGIN [NewUser]
--GO
--CREATE ROLE [LinearStateEstimatorManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'LinearStateEstimatorManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'LinearStateEstimatorManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'LinearStateEstimatorManagerRole'
--GO
