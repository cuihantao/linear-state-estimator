...
GO
INSERT INTO Device(NodeID, Acronym, Name, IsConcentrator, CompanyID, HistorianID, AccessID, VendorDeviceID, ProtocolID, Longitude, Latitude, InterconnectionID, ConnectionString, MeasuredLines, LoadOrder, Enabled) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 'TESTDEVICE', 'Test Device', 0, 30, 1, 2, 2, 3, -89.8038, 35.3871, 1, 'transportProtocol=File; file=Sample1344.PmuCapture; useHighResolutionInputTimer=True', 3, 0, 1)
GO
...
GO
INSERT INTO ApplicationRole (Name, Description, NodeID) VALUES ('Editor', 'Editor', 'facd14d5-56b5-4f63-a8d8-56e830bf6f7c')
GO
